...
import p012ch.qos.logback.core.rolling.helper.TimeBasedArchiveRemover;

/* renamed from: ch.qos.logback.core.rolling.DefaultTimeBasedFileNamingAndTriggeringPolicy */
public class DefaultTimeBasedFileNamingAndTriggeringPolicy<E> extends TimeBasedFileNamingAndTriggeringPolicyBase<E> {
    public void start() {
        super.start();
        this.archiveRemover = new TimeBasedArchiveRemover(this.tbrp.fileNamePattern, this.f1668rc);
