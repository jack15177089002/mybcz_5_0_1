...
public class PullToRefreshMorePager extends PullToRefreshBase<ViewPager> {
    public PullToRefreshMorePager(Context context) {
        super(context);
    ...
    public PullToRefreshMorePager(Context context, AttributeSet attributeSet) {
...
//        viewPager.setId(R.id.wordlock_more_pager);
