...
public final class C1566ab implements Cache {

    /* renamed from: b */
    LinkedHashMap<String, Bitmap> f3601b = null;
    ...
    public C1566ab(Context context) {
        this(C1584bj.m3565c(context));
    }

    public C1566ab(int i) {
        if (i <= 0) {
            throw new IllegalArgumentException("Max size must be positive.");
        }
        this.f3602c = i;
        this.f3601b = new LinkedHashMap<>(0, 0.75f, true);
    }

    /* renamed from: a */
    public final Bitmap mo16281a(String str) {
        if (str == null) {
            throw new NullPointerException("key == null");
        }
        synchronized (this) {
            Bitmap bitmap = (Bitmap) this.f3601b.get(str);
            if (bitmap != null) {
                this.f3606g++;
                return bitmap;
            }
    ...
    /* renamed from: a */
    public final void mo16283a(String str, Bitmap bitmap) {
        ...
        synchronized (this) {
            ...
            Bitmap bitmap2 = (Bitmap) this.f3601b.put(str, bitmap);
            if (bitmap2 != null) {
    ...
    public final void mo16282a(int r4) {
        ...
        L_0x0000:
            ...
            java.util.LinkedHashMap<java.lang.String, android.graphics.Bitmap> r0 = r3.f3601b     // Catch:{ all -> 0x0032 }
        ...
        L_0x0043:
            ...
            java.util.LinkedHashMap<java.lang.String, android.graphics.Bitmap> r2 = r3.f3601b     // Catch:{ all -> 0x0032 }
